...
if __name__ == '__main__':
	...
	print(f"num_users: {str(num_users)}")
	print(f"num_item: {str(num_items)}")
	...
	print(f"train_loader: {str(len(train_loader))}")
	print(f"test_loader: {str(len(test_loader))}")
	...
	# train, evaluation
	best_hr = 0
	print(f"Nr epochs: {str(args.epochs+1)}")
