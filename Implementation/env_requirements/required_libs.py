required_libs = ['absl-py==1.3.0', 
                 'aiohttp==3.8.3', 
                 'aiosignal==1.2.0', 
                 'anyio==3.5.0', 
                 'appnope==0.1.2', 
                 'argon2-cffi-bindings==21.2.0', 
                 'argon2-cffi==21.3.0', 'asttokens==2.0.5', 
                 'async-timeout==4.0.2', 'attrs==22.1.0', 
                 'backcall==0.2.0', 'beautifulsoup4==4.11.1', 
                 'bleach==4.1.0', 'blinker==1.4', 'brotlipy==0.7.0', 
                 'cachetools==4.2.2', 'certifi==2022.12.7', 'cffi==1.15.1', 
                 'charset-normalizer==2.0.4', 'click==8.0.4', 'comm==0.1.2', 
                 'cryptography==38.0.4', 'cycler==0.11.0', 'debugpy==1.5.1', 
                 'decorator==5.1.1', 'defusedxml==0.7.1', 'docker-pycreds==0.4.0', 
                 'entrypoints==0.4', 'executing==0.8.3', 'fastjsonschema==2.16.2', 
                 'flask==2.1.0', 'flit-core==3.6.0', 'frozenlist==1.3.3', 'gitdb==4.0.10', 
                 'gitpython==3.1.29', 'google-auth-oauthlib==0.4.4', 'google-auth==2.6.0', 
                 'grpcio==1.42.0', 'gunicorn==20.0.4', 'idna==3.4', 'importlib-metadata==4.11.3', 
                 'importlib-resources==5.2.0', 'ipykernel==6.19.2', 'ipython-genutils==0.2.0', 'ipython==8.10.0', 'ipywidgets==7.6.5', 
                 'itsdangerous==2.1.2', 'jedi==0.18.1', 'jinja2==3.1.2', 'joblib==1.2.0', 'jsonschema==4.17.3', 'jupyter-client==7.4.9', 
                 'jupyter-core==5.2.0', 'jupyter-server==1.23.4', 'jupyterlab-pygments==0.1.2', 
                 'jupyterlab-widgets==1.0.0', 'kiwisolver==1.4.4', 'lxml==4.9.1', 'markdown==3.4.1', 
                 'markupsafe==2.1.1', 'matplotlib-inline==0.1.6', 'matplotlib==3.3.3', 'metanet==0.1', 
                 'mistune==0.8.4', 'mkl-fft==1.3.1', 'mkl-random==1.2.2', 'mkl-service==2.4.0', 
                 'multidict==6.0.2', 'nbclassic==0.5.2', 'nbclient==0.5.13', 'nbconvert==6.5.4', 
